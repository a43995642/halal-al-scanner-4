        ...
        <div className="flex-grow p-6 flex flex-col items-center text-center justify-center">
           ...
           {currentStep === 1 && (
             <div className="animate-slide-up flex flex-col items-center">
               ...
               <p className="text-gray-400 leading-relaxed mb-4 max-w-xs" dangerouslySetInnerHTML={{ __html: t.pointCameraAt || "Point camera at the <strong class=\"text-white\">Ingredients List</strong>." }} />
